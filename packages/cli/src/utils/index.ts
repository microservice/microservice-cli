...
export { default as readOMSFile } from './readOMSFile'
...
export { default as getOMSFilePath } from './getOMSFilePath'
export { default as checkValidOMSDirectory } from './checkValidOMSDirectory'
