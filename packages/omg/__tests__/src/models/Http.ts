    ...
    test('throws an exception because the json is not valid', () => {
      try {
        ...
        expect(e).toEqual({
          ...
          issue: {},
          text: 'actions.actionName.http should have required property \'method\', actions.actionName.http should have required property \'port\', actions.actionName.http should have required property \'path\'',
          valid: false,
        });
      }
    });
    ...
    test('throws an exception because the json is not valid', () => {
      try {
        ...
        expect(e).toEqual({
          ...
          issue: {method: 'get'},
          text: 'actions.actionName.http should have required property \'port\', actions.actionName.http should have required property \'path\'',
          valid: false,
        });
      }
    });
