...
export const HELP_OMS_SPEC_WEBSITE = 'https://microservice.guide/schema/info/'
export const HELP_OMS_GETTING_STARTED_WEBSITE = 'https://microservice.guide/introduction/overview/'
