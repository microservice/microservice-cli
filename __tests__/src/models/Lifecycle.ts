    ...
    test('throws an exception because the json is not valid', () => {
      try {
        ...
        expect(e).toEqual({
          ...
          issue: {},
          text: 'lifecycle should have required property \'startup\', lifecycle should have required property \'shutdown\', lifecycle should match exactly one schema in oneOf',
          valid: false,
        });
      }
    });
